 ...
 const content = `
  <main>
    <section class="about">
      ...
      <p>
        Um evento feito por e para pessoas desenvolvedoras apaixonadas por criar soluções inovadoras e compartilhar conhecimento. Vamos mergulhar nas tendências mais recentes em desenvolvimento de software, arquitetura de sistemas e tecnologias emergentes, com palestras, worshops e hackathons. 
        <br/>
        <br/>
    ...
    <section class="registration">
      ...
      <form id="form">
        ...
        <button>
          Confirmar
          <img class="arrow-icon" src="arrow.svg" alt="Arrow right">
        </button>
      </form>
    </section>
  </main>
